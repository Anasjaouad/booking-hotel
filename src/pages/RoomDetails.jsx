    ...
    <div className='max-w-5xl mx-auto px-40 pt-60'>
       <div class Name='text-center'>
          ...
          <p className='mb-2'>{hotel.city}</p>
           ...
           justify-center gap-2'><FaLocationArrow/>{hotel.address},{hotel.city}
          </p>
           <img className='w-full h-96 object-cover rounded-xl shadow-md mb-6'    
         src={hotel.images}/>
    </div>
    <div className='grid sm:grid-cols-1 md:grid-cols-2 '>
<div>
    <h2 className='font-bold'>Romm Type</h2>
...
<div>
 ...
 <p>{hotel.rating} </p>
 <div className='flex items-ceter text-yellow-400 
 mb-2'>
...
<p className={hotel.isAvailable ? 
'text-green-500': 'text-red-500'}>
  
{hotel.isAvailable? 
'Availlable':'not Availlable'}
